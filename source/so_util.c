...
void so_finalize(so_module *mod) {
  ...
  // Flush data cache of the backing memory before mapping it (while it is still accessible)
  ...
  // Invalidate instruction cache of the executable mapping after it is fully mapped and permissions set
